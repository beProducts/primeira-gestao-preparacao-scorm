...
export default {
  ...
  data() {
    return {
      url: "https://empreenda-se.digital/products/primeira-gestao/content/9-mapa-de-investigacao-da-area/index.html",
      timeSpentOnPage: 0,
      mainTimer: null,
      alarmTimer: null,
      enterTime: null
  ...
  mounted() {
    if(process.env.VUE_APP_SCORM_MODE === "ON" ){
      this.url = "content/9-mapa-de-investigacao-da-area/index.html";
    }
