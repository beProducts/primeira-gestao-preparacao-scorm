...
export default {
  ...
  data() {
    return {
      url: "https://empreenda-se.digital/products/primeira-gestao/content/10-estresse-e-nervosismo/index.html",
      timeSpentOnPage: 0,
      mainTimer: null,
      alarmTimer: null,
    };
  ...
  mounted() {
    if(process.env.VUE_APP_SCORM_MODE === "ON" ){
      this.url = "content/10-estresse-e-nervosismo/index.html";
    }
