<template>
  <div class="main">
    <div class="scroll-wrapper">
      <iframe ref="content" id="content" src="https://empreenda-se.digital/products/primeira-gestao/content/8-mapa-de-investigacao-do-negocio/index.html" allowfullscreen></iframe>
    </div>
    <div class="toolbar">
      <ToolBar />
    </div>
