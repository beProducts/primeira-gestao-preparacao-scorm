<template>
  <div class="main">
    <div class="scroll-wrapper">
      <iframe ref="content" id="content" src="https://empreenda-se.digital/products/primeira-gestao/content/65-mais-sobre-gerir-a-si-mesmo/index.html" allowfullscreen></iframe>
    </div>
    <div class="toolbar">
      <ToolBar />
    </div>
